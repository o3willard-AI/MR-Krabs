...
class OpenAICompatibleAdapter(BaseProviderAdapter):
    ...
    def call_sync(self, messages: List[Dict[str, str]], model: Optional[str] = None, **kwargs) -> "LLMResponse":
        ...
        raise RuntimeError(
            "call_sync() called from inside an async event loop. "
            "Use await adapter.complete() directly."
        )
